...
int Interrupt::Write(char* buffer, int ch_size, int id)
{
    return kernel->Write(buffer, ch_size, id);
}

int Interrupt::Read(char* buffer, int ch_size, int id)
{
    return kernel->Read(buffer, ch_size, id);
}
